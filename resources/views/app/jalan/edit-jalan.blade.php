...
@endsection
@section('isi')
    <h1 class="h3 mb-4 text-gray-800">Edit Data Jalan</h1>
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/data-jalan/{{ $jalan->id }}/update">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="nama_jalan">Nama Jalan</label>
                                <input type="text" class="form-control" id="nama_jalan" placeholder="Nama Jalan"
                                    name="nama_jalan" value="{{ $jalan->nama_jalan }}">
...
@section('js')
    ...
    var osm = L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
        ...
        var marker = L.marker([{{  $jalan->lat  }}, {{ $jalan->long }}], {
            draggable: true
        }).addTo(map);
