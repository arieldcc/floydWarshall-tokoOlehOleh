        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Data Toko</h6>
                </div>
                <div class="card-body">

                    <form method="POST" action="/simpan-toko" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="alamat_lengkap" id="alamat_lengkap" rows="5" class="form-control @error('alamat_lengkap') is-invalid @enderror"></textarea>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="ket" id="ket" rows="5" class="form-control @error('ket') is-invalid @enderror"></textarea>
                                @if ($errors->has('ket'))
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('waktu_buka') is-invalid @enderror" id="waktu_buka" placeholder="Waktu Toko Beroperasi"
                                    name="waktu_buka" value="{{ old('waktu_buka') }}">
